...
/*package*/ class DefinitionsEntry_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public DefinitionsEntry_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_d1f3x_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "Packages");
    editorCell.setCellId("Constant_d1f3x_a0");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_d1f3x_a1a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_d1f3x_b0");
  ...
  public Grid createChildsVertical_d1f3x_a1a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);


    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.packages$ZZUp)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.packages$ZZUp);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$ZZUp)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$ZZUp)).getElement(y) : null), LINKS.packages$ZZUp);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$ZZUp)).isEmpty()) {
      EditorCell placeholder = new EditorCellFactory(editorContext, node, grid).createPlaceholderConstant("<no packages>");
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.packages$ZZUp, editorContext);
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink packages$ZZUp = MetaAdapterFactory.getContainmentLink(0xe303062338bb48cbL, 0xae7ef3be4cd83f0eL, 0x65c9ffa81d1af143L, 0x65c9ffa81d1af15fL, "packages");
  }
}
