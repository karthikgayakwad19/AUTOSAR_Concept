...
/*package*/ class ValuesEntry_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public ValuesEntry_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_2bpq9a_a");
        ...
        EditorCacheHacks.noCaching(editorContext, new Runnable() {
          public void run() {
            try {
              ...
              final Grid childGrid = createChildsVertical_2bpq9a_a0a(editorContext, node);
              ...
              editorCell.value.setCellId("Table_2bpq9a_a0");
  ...
  public Grid createChildsVertical_2bpq9a_a0a(final EditorContext editorContext, final SNode node) {
    Grid grid = new Grid();
    GridAdapter gridAdapter = new GridAdapter(grid, editorContext, node);


    final IHeaderNodeInsertAction insertAction = new ChildNodesInsertAction(node, SLinkOperations.findLinkDeclaration(LINKS.packages$hA91)) {};
    ...
    try {
      ...
      int y = 0;
      Iterable<SNode> elements = SLinkOperations.getChildren(node, LINKS.packages$hA91);
      for (SNode child : Sequence.fromIterable(elements)) {
        ...
        SubstituteInfo substituteInfo = SubstituteUtil.forChild(editorContext, node, (y < ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$hA91)).count() ? ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$hA91)).getElement(y) : null), LINKS.packages$hA91);
    ...
    if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.packages$hA91)).isEmpty()) {
      ...
      SubstituteInfo substituteInfo = new DefaultSChildSubstituteInfo(node, null, LINKS.packages$hA91, editorContext);
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink packages$hA91 = MetaAdapterFactory.getContainmentLink(0xef22f920a15b4c66L, 0xa06ee0c4aea10605L, 0x65c9ffa81d1af161L, 0x65c9ffa81d1af162L, "packages");
  }
}
